...
@section('page-title', 'Mon Profil Enseignant')
...
@section('menu')
    ...
    <a href="{{ route('enseignant.profile') }}" class="active">
    ...
    <div class="row">
        <div class="col-md-4 mb-4">
            <div class="card border-0 shadow-sm">
                ...
                <div class="card-body text-center">
                    ...
                    <p class="text-muted mb-0">{{ $enseignant->grade }}</p>
        ...
        <div class="col-md-8 mb-4">
            <div class="card border-0 shadow-sm">
                ...
                <div class="card-body">
                    <form action="{{ route('enseignant.profile.update') }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control bg-light" 
                                       value="{{ $enseignant->matricule }}" readonly>
                            </div>
                            <div class="col-md-6 mb-3">
                                <label class="form-label">Nom complet</label>
                                <input type="text" class="form-control bg-light" 
                                       value="{{ $enseignant->prenom }} {{ $enseignant->nom }}" readonly>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control bg-light" 
                                       value="{{ $enseignant->grade }}" readonly>
                            </div>
                            <div class="col-md-6 mb-3">
                                <label class="form-label">Spécialité</label>
                                <input type="text" class="form-control bg-light" 
                                       value="{{ $enseignant->specialite }}" readonly>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control bg-light" 
                                       value="{{ $enseignant->departement->nom_departement ?? 'Non affecté' }}" readonly>
                            </div>
                            <div class="col-md-6 mb-3">
                                <label class="form-label">Membre depuis</label>
                                <input type="text" class="form-control bg-light" 
                                       value="{{ $enseignant->created_at->format('d/m/Y') }}" readonly>
                            </div>
                        </div>
